...
export const productCategories = [
  {
    ...
    cols: 4,
    items: [
      { image: "1041-Litre-Tote-Hand-Sanitiser.png", title: "Sanitiser & Protectant", size: "1041 Litre Tote" },
      { image: "Hand-Sanitiser-5L-Jerry-Can.png", title: "Sanitiser & Protectant", size: "5L Container" },
      { image: "Hand-Sanitiser-500ml-Pump-Action-Foamer.png", title: "Sanitiser & Protectant", size: "500ml Bottle" },
      { image: "Hand-Sanitiser-50ml-Pump-Action-Foamer.png", title: "Sanitiser & Protectant", size: "50ml Bottle" },
    ],
  },
  {
    id: "surfaces",
    ...
    cols: 3,
    items: [
      { image: "1041-Litre-Tote-Surface-Protector.png", title: "Surfaces Product", size: "1041 Litre Tote" },
      { image: "Surface-Protector-5L-Jerry-Can.png", title: "Surfaces Product", size: "5L Container" },
      { image: "Surface-Protector-750ml-Trigger-Spray.png", title: "Surfaces Product", size: "750ml Bottle" },
    ],
  },
  {
    id: "laundry",
    ...
    cols: 3,
    items: [
      { image: "1041-Litre-Tote-Laundry-Protector.png", title: "Laundry Product", size: "1041 Litre Tote" },
      { image: "Laundry-Protector-5L-Jerry-Can.png", title: "Laundry Product", size: "5L Container" },
      { image: "Laundry-Protector-1L-Bottle.png", title: "Laundry Product", size: "1 Litre Bottle" },
    ],
  },
  {
    id: "masks",
    ...
    cols: 1,
    items: [
      { image: "mask-outer.png", title: "FFP3 Antiviral and Antibacterial Mask", size: "G036S" },
    ],
  },
] as const;

export const markets = [
  { id: "healthcare", name: "Healthcare", image: "health-image.jpg", subs: ["Dr. Offices", "Hospitals", "Nursing Care"], detail: "Hospitals, Doctors Surgeries, Care Homes, Nursing Care Facilities" },
  { id: "government", name: "Government & Military", image: "government-image.jpg", subs: ["Bases", "Municipal", "Offices"], detail: "Offices, Town & City Centres, Prisons, Bases, Recreation Parks" },
  { id: "hospitality", name: "Hospitality", image: "hospitality-image.jpg", subs: ["Airbnb", "Hotels", "Vacation Rentals"], detail: "Hotels, Airbnb, Holiday Rentals" },
  { id: "veterinary", name: "Veterinary", image: "veterinary-image.jpg", subs: ["Animal Hospitals", "Groomers"], detail: "Animal Hospitals, Vets & Groomers" },
  { id: "travel", name: "Travel", image: "Travel.png", subs: ["Airlines", "Cruise Liners"], detail: "Airlines, Cruise Liners" },
  { id: "transportation", name: "Transportation", image: "Transportation.png", subs: ["Buses", "Cabs", "Subways"], detail: "Buses, Taxis, Underground Trains, Uber, Lyft" },
  { id: "sports", name: "Sports", image: "Sports.png", subs: ["Arenas", "Facilities", "Stadiums"], detail: "Arenas, Facilities, Stadiums" },
  { id: "schools", name: "Schools", image: "Schools.png", subs: ["K-12", "Universities"], detail: "K-12, Universities" },
  { id: "retail", name: "Retail", image: "Retail.png", subs: ["Malls", "Cinemas", "Stores"], detail: "Stores, Shopping Centres, Cinemas" },
  { id: "outdoor", name: "Outdoor", image: "Outdoor.png", subs: ["Boating", "Camping"], detail: "Camping, Boating / Marine" },
  { id: "office", name: "Office & Commercial", image: "office.png", subs: ["Surfaces", "Reception", "Lifts"], detail: "Surfaces, Lifts, Reception Areas & Toilets" },
  { id: "laundry", name: "Laundry & Textiles", image: "Laundry.png", subs: ["Uniforms", "Linens"], detail: "Uniforms & Linens" },
  { id: "hvac", name: "HVAC", image: "HVAC.png", subs: ["New Construction", "Service"], detail: "New Construction, Service" },
  { id: "home", name: "Home", image: "Home.png", subs: ["Bath", "Kitchen", "Living Room"], detail: "Kitchen, Bath, Living Rooms, Hands, Surfaces" },
  { id: "food", name: "Food & Beverage", image: "Food.png", subs: ["Cafeterias", "Restaurants"], detail: "Restaurants, Cafes, Catering" },
  { id: "fitness", name: "Fitness", image: "Fitness.png", subs: ["Gyms", "Trampoline Parks", "Yoga Studios"], detail: "Gyms, Yoga Studios, MMA, Trampoline Parks" },
  { id: "events", name: "Events & Conventions", image: "Events.png", subs: ["Convention Centres", "Music Venues"], detail: "Convention Centres, Fayres, Music Venues" },
  { id: "cleaning", name: "Cleaning & Applicators", image: "Cleaning.png", subs: ["Commercial Cleaning"], detail: "Commercial Cleaning Companies" },
  { id: "cannabis", name: "Cannabis & Horticulture", image: "Cannabis.png", subs: ["Grow Houses", "Vegetables"], detail: "Grow Houses, Fruit Farms, Vegetables" },
  { id: "agriculture", name: "Agriculture", image: "Agriculture.png", subs: ["Livestock", "Poultry"], detail: "Poultry, Livestock, Processing, Feed & Grain" },
] as const;
